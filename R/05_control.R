#' Control Parameters for Fitting Multivariate BCS-NSM Models
#'
...
#'
#' @param method Optimization method. See “Details” in \code{\link[stats]{optim}}. 
#'     Default is \code{"BFGS"}.
#' @param maxit Maximum number of iterations. Default is \code{2000}.
#' @param hessian Logical. If \code{TRUE}, the asymptotic covariance matrix (\code{vcov}) 
#'     estimated using the optim's numerical Hessian matrix is returned by the function 
#'     \code{\link{bcsnsm}}.
#' @param inits Optional list of initial values for model parameters. It must be passed with the elements: 
#'     \itemize{
